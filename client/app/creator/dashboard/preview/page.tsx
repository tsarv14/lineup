      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                <Link
                  href={storefront.handle ? `/creator/${storefront.handle}/picks` : '#'}
        ...
        <div className="mb-12">
          <div className="flex items-center gap-4 mb-6">
            <Link href={storefront.handle ? `/creator/${storefront.handle}` : '#'} className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                href={`/login?redirect_url=/creator/${storefront.handle || ''}`}
                className="px-4 py-2 bg-transparent border border-white/20 text-white rounded-lg hover:bg-white/10 transition-colors"
              >
        ...
        {plans.length > 0 && (
          <div id="subscription-plans" className="mb-16">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
              {plans.slice(0, 3).map((plan) => (
                <div key={plan._id} className="bg-slate-900 border border-slate-800 rounded-lg p-6">
                  ...
                  <Link
                    href={storefront.handle ? `/creator/${storefront.handle}/subscribe/${plan._id}${selectedBillingVariant ? `?pid=${selectedBillingVariant}` : ''}` : '#'}
            ...
            {plans.length > 3 && (
              <div className="text-center">
                <Link
                  href={storefront.handle ? `/creator/${storefront.handle}/plans` : '#'}
            ...
            <div className="space-y-4">
              {filteredPicks.slice(0, 10).map((pick) => (
                <div key={pick._id} className="bg-slate-900 border border-slate-800 rounded-lg p-6 hover:border-primary-500 transition-colors">
                  ...
                  <Link
                    href={storefront.handle ? `/creator/${storefront.handle}/pick/${pick._id}` : '#'}
